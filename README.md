...
Проект работает без серверной сборки: достаточно открыть `index.html` в браузере, чтобы:

- создать новую заметку;
- выбрать цвет для визуального выделения;
- пометить заметку как избранную;
- отфильтровать и удалить заметки.

## Screenshots

> Здесь можно добавить изображения интерфейса для портфолио: главную страницу, форму создания заметки, фильтр избранных и диалог удаления.

---

Если необходимо, могу добавить живой пример `Демо` или скриншоты с интерфейсом приложения.
